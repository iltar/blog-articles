...
A lot of developers who come to `#symfony` ask how to implement login or authentication system. It's quite common to
...
will get relations to other objects and this will goes several side-effects:
 - Relations will be serialized too
...
with incomplete objects because of missing properties.
...
The sole responsibility of this object is to implement the `UserInterface` and provide the system with Authentication.
